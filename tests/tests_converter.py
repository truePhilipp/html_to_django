...
from html_to_django.converter import get_required_libraries, convert_file, convert_dir
...
class ConverterTests(TestCase):
    ...
    def test_convert_file_nonexistent(self) -> None:
        with self.assertRaises(FileNotFoundError):
            convert_file(os.path.abspath("tests/test/project/nonexistent_file.html"))

    def test_convert_file_dir_passed(self) -> None:
        with self.assertRaises(FileNotFoundError):
            convert_file(os.path.abspath("tests/test_project"))
